...
const FooterBlock = ({}: FooterBlockProps) => {
  ...
  const Footer = ({ startY, endY, location1, location2, location3 }: any) => {
    return (
      <LinearGradient
        ...
        <View
          ...
          <View
            ...
            <View
              // @ts-ignore
              style={styles.logo}>
              <svg id="a" width="120" height="120" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 476 476">
                <path
                ...
                <path
                  d="M238,289.75l-57.23-111.75.19-.36,57.05-111.39,57.23,111.75-.19.36-57.05,111.39ZM182.57,178l55.43,108.25,55.44-108.25-55.44-108.25-55.43,108.25Z"
                  fill="#fff"
                  stroke-width="0"
                />
            ...
            <View style={{ marginTop: s(40), width: '100%', alignItems: 'center' }}>
  ...
  if (screenSize.width < 540) {
    return <Footer startY={0.9} endY={1.0} location1={0.3} location2={0.8} location3={0.9} />
  }
